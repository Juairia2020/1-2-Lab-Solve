...
double area(Point p1, Point p2, Point p3) {
    return abs(p1.getx() * p2.gety() + p2.getx() * p3.gety() + p3.getx() * p1.gety() - p1.gety() * p2.getx() - p2.gety() * p3.getx() - p3.gety() * p1.getx()) / 2.00;
}
...
int main() {
    ...
    cout << "Points of Triangle : \nP1(" << p1.getx() << "," << p1.gety() << "), P2(" << p2.getx() << "," << p2.gety() << "),P3(" << p3.getx() << "," << p3.gety() << ")\n";
    cout << fixed << setprecision(2) << "Area of triangle = " << area(p1, p2, p3) << endl;
    return 0;
